...
export default function Options({ info }) {
  ...
  const participant =
    info.receiver.email === myEmail ? info.sender : info.receiver;
  ...
  return (
    ...
    >
      <input
        type="text"
        placeholder="Message"
        className="block w-full py-2 pl-4 mx-3 bg-gray-100 focus:ring focus:ring-violet-300 rounded-full outline-none focus:text-gray-700"
        name="message"
        required
        value={message}
