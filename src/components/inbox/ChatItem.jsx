...
export default function ChatItem({ id, avatar, name, lastMessage, lastTime }) {
  return (
    <Link
      className="flex items-center px-3 py-2 text-md transition duration-150 ease-in-out border-b border-gray-300 cursor-pointer hover:bg-gray-100 focus:outline-none"
      to={`/inbox/${id}`}
    >
      <img
